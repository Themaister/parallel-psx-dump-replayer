...
namespace Vulkan
{
   ...
   void CommandBuffer::copy_buffer(const Buffer &dst, VkDeviceSize dst_offset,
         const Buffer &src, VkDeviceSize src_offset, VkDeviceSize size)
   {
      ...
      vkCmdCopyBuffer(cmd, src.get_buffer(), dst.get_buffer(),
            1, &region);
   }
         ...
         VkAccessFlags dst_access)
   {
      ...
      vkCmdPipelineBarrier(cmd,
            src_stages, dst_stages, 0, 0, nullptr, 1, &barrier, 0, nullptr);
   }
}
